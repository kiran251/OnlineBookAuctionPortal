...
<html>
    ...
    <body>
        ...
        <div id="loginFail">
        <img id="errImg" src="error.jpg" alt="Error" width="70" height="70"/>
        <h3 id="loginError">Username/Password does not match. Please <a href="Login.jsp">click here</a> to try logging in again</h3>
        </div>
        <div class="footer"> 
